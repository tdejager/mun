...
impl Connection {
    /// Create a connection that communicates over stdout and stdin. This enables inter-process
    /// communication.
    ...
    /// Create a pair of connected connections. This enables in-process communication especially
    /// useful for testing.
    ...
    /// If `req` is a `Shutdown`, respond to it and return `true`, otherwise return `false`.
