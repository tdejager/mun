...
/// A error code indicating the error type that occured.
...
impl Response {
    ...
    /// Constructs a `Response` object signalling a failed handling of a request with the specified
    /// id.
...
impl Request {
    ...
    /// Try to extract the specific request parameters from this request.
...
impl Notification {
    ...
    /// Try to extract the specific notification parameters from this notification.
...
/// Read an RPC message from the specified stream.
